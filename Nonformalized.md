...
###Методы объекта
 Метод | Описание
 -------------------------------------------------- | ----------------------------------------------
 [GetRejectionComment](GetRejectionComment (Nonformalized)) | Возвращает комментарий к отказу в подписании
 [Accept](Accept (Nonformalized)) | Формирует подпись получателя документа
 [Reject](Reject (Nonformalized)) | Формирует отказ в подписании документа
