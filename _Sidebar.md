  ...
  - [Документы](Документы)
    ...
    - [Производные методы](Производные методы)
      ...
      - [InvoiceRevision](InvoiceRevision)
        ...
        - [Content](Content (InvoiceRevision))
          - [InvoiceContent](InvoiceContent (InvoiceRevision))
          - [AddItem](AddItem (InvoiceRevisionContent))
          - [InvoiceItem](InvoiceItem (InvoiceRevision))
          - [AddPaymentDocument](AddPaymentDocument (InvoiceRevisionContent))
          - [PaymentDocument](PaymentDocument (Дубль))
          - [Итоги InvoiceTotals](Итоги InvoiceTotals (Revision))
