...
####[Рекомендации по переводу кастомизированных модулей интеграции на новый формат счет-фактуры](Рекомендации по переводу кастомизированных модулей интеграциий на новы формат счет-фактуры)
