| Данный объект предназначен для работы с документами в
  неформализованном
...
| Метод                                                             | Описание                                       |
+===================================================================+================================================+
| `GetRejectionComment <GetRejectionComment%20(Nonformalized)>`__   | Возвращает комментарий к отказу в подписании   |
+-------------------------------------------------------------------+------------------------------------------------+
| `Accept <Accept%20(Nonformalized)>`__                             | Формирует подпись получателя документа         |
+-------------------------------------------------------------------+------------------------------------------------+
| `Reject <Reject%20(Nonformalized)>`__                             | Формирует отказ в подписании документа         |
+-------------------------------------------------------------------+------------------------------------------------+
