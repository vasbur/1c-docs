...
| объектом от `Document <Документы>`__.
...
| Метод                                                                                  | Описание                                       |
+========================================================================================+================================================+
| `GetRejectionComment <GetRejectionComment%20(NonformalizedAcceptanceCertificate)>`__   | Возвращает комментарий к отказу в подписании   |
+----------------------------------------------------------------------------------------+------------------------------------------------+
| `Accept <Accept%20(NonformalizedAcceptanceCertificate)>`__                             | Формирует подпись получателя документа         |
+----------------------------------------------------------------------------------------+------------------------------------------------+
| `Reject <Reject%20(NonformalizedAcceptanceCertificate)>`__                             | Формирует отказ в подписании документа         |
+----------------------------------------------------------------------------------------+------------------------------------------------+
