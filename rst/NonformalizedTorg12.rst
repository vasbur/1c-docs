...
| Метод                                                                   | Описание                                       |
+=========================================================================+================================================+
| `GetRejectionComment <GetRejectionComment%20(NonformalizedTorg12)>`__   | Возвращает комментарий к отказу в подписании   |
+-------------------------------------------------------------------------+------------------------------------------------+
| `Accept <Accept%20(NonformalizedTorg12)>`__                             | Формирует подпись получателя документа         |
+-------------------------------------------------------------------------+------------------------------------------------+
| `Reject <Reject%20(NonformalizedTorg12)>`__                             | Формирует отказ в подписании документа         |
+-------------------------------------------------------------------------+------------------------------------------------+
