...
| Метод                                                                          | Описание                                                                                          |
+================================================================================+===================================================================================================+
| `GetRejectionComment <GetRejectionComment%20(XmlAcceptanceCertificate)>`__     | Возвращает комментарий к отказу в подписании                                                      |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
| `Reject <Reject%20(XmlAcceptanceCertificate)>`__                               | Формирует отказ в подписании документа                                                            |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
| `GetContent <GetContent%20(XmlAcceptanceCertificate)>`__                       | Возвращает содержание документа (титул исполнителя) в виде объектной модели                       |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
| `GetBuyerContent <GetBuyerContent%20(XmlAcceptanceCertificate)>`__             | Возвращает содержание документа (титул заказчика) в виде объектной модели                         |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
| `CreateReplySendTask <CreateReplySendTask%20(XmlAcceptanceCertificate)>`__     | Формирует задание для отправки титула заказчика (для подписания документа со стороны заказчика)   |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
| `SaveRecipientContent <SaveRecipientContent%20(XmlAcceptanceCertificate)>`__   | Сохраняет содержимое титула покупателя на локальный диск                                          |
+--------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------+
