Скачайте zip архив, содержащий файл компоненты и файл сопровождения - [AddInDiadocApi.zip](https://github.com/skbkontur/DiadocSDK-1C/blob/master/v40/AddInDiadocApi.zip)
